...
## 2. Expiration Date SHOULD Be Set for Anyone Links
...
## 3. Link Permissions SHOULD Be Set to Enabled Anyone Links to View
...
## 4. OneDrive Client SHALL Be Restricted to Windows for Agency-Defined Domain(s)
...
## 5. OneDrive Client SHALL Be Restricted to Sync with Mac for Agency-Defined Devices
...
## 6. OneDrive Client Sync SHALL Only Be Allowed Within the Local Domain
...
## 7. Legacy Authentication SHALL Be Blocked 
